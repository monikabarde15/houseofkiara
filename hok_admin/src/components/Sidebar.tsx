...
const groups = [
  ...
  { title: 'Catalogue', items: [{ id: 'products', label: 'Products', icon: Package }, { id: 'designers', label: 'Designers', icon: Award }, { id: 'listers', label: 'Listers', icon: UserCheck }, { id: 'lyp', label: 'LYP Submissions', icon: Grid }, { id: 'occasions', label: 'Occasions & Sizes', icon: Grid }] },
