...
interface AgendaRowDetailProps {
  entry: AgendaEntry;
...
const AgendaRowDetail: React.FC<AgendaRowDetailProps> = ({
  ...
  return (
    <div className="agenda-detail">
      <div className="agenda-detail__left">
        <h3 className="agenda-detail__title">{entry.detail.title}</h3>
        <p className="agenda-detail__subtitle">{entry.detail.subtitle}</p>

        <div className="agenda-detail__section">
          <div className="agenda-detail__label">DUE</div>
          <div className="agenda-detail__value">{entry.detail.dueDate}</div>
        </div>
      ...
      <div className="agenda-detail__right">
        <div className="agenda-detail__label">NOTES</div>
        <textarea
          className="agenda-detail__textarea"
...
export default AgendaRowDetail;