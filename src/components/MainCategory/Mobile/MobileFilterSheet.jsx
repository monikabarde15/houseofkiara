...
const MobileFilterSheet = ({ isOpen, onClose, onApply, filters, setFilters }) => {
    ...
    const [openGroups, setOpenGroups] = useState({
        shopBy: true, category: true, occasion: true, designer: true,
        price: false, availability: false, size: false, colour: false
    });
    ...
    // ===== SWIPE GESTURE HANDLERS - Spec §28.2 =====
    ...
    const handleTouchEnd = (e) => {
        ...
        // Swipe down > 80px AND minimal horizontal movement
        if (dy > 80 && dx < 40) {
            handleClose();
        }
    };

    // ===== DISMISSAL METHODS - Spec §28.1 =====
    const handleClose = () => {
        onClose();
    };
    ...
    return (
        <>
            {/* Overlay - taps to close - Spec §28.1 */}
            <div className="mob-filter-overlay" onClick={handleClose} />

            {/* Filter Sheet - with swipe gestures - Spec §28.2 */}
            <div
                className="mob-filter-sheet"
                ref={sheetRef}
            ...
            >
                ...
                <div className="mob-filter-sheet__header">
                    ...
                    <button className="mob-filter-sheet__clear-btn" onClick={handleResetAndClose}>
                        Clear All
                    </button>
                </div>
                ...
                {/* Footer - Reset closes, Apply applies and closes - Spec §28.1 */}
                <div className="mob-filter-sheet__footer">
                    <button className="mob-filter-sheet__reset-btn" onClick={handleResetAndClose}>
                        Reset
                    </button>
                    <button className="mob-filter-sheet__apply-btn" onClick={handleApplyAndClose}>
                        Show Results
                    </button>
                </div>
