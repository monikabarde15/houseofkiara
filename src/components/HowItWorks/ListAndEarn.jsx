...
const ListAndEarn = () => {
  ...
  return (
    <section id="section-sell" className="hok-hiw-list-earn">
      {/* Earn Watermark */}
      <span className="hok-hiw-le-watermark">Earn</span>

      <div className="hok-hiw-le-container">
        {/* Left Column */}
        <div className="hok-hiw-le-left">
          {/* Eyebrow */}
          <div className="hok-hiw-le-eyebrow">
            <span className="hok-hiw-le-line"></span>
            <span className="hok-hiw-le-eyebrow-text">List & Earn</span>
          </div>

          {/* Title */}
          <h2 className="hok-hiw-le-title">
          ...
          {/* Commission Table */}
          <div className="hok-hiw-le-table">
            {/* Row 1 */}
            <div className="hok-hiw-le-row">
              <div className="hok-hiw-le-row-left">
                <div className="hok-hiw-le-mode-label">Rental listing</div>
                <div className="hok-hiw-le-sub-label">Per booking, to you</div>
              </div>
              <div className="hok-hiw-le-figure">40%</div>
            </div>
            ...
            <div className="hok-hiw-le-row">
              <div className="hok-hiw-le-row-left">
                <div className="hok-hiw-le-mode-label">Payout timeline</div>
        ...
        <div className="hok-hiw-le-right">
          ...
          <div className="hok-hiw-sstep">
            ...
            <div className="hok-hiw-sstep-content">
              <div className="hok-hiw-sstep-title">Photograph & List</div>
              <div className="hok-hiw-sstep-tag">
                <span className="hok-hiw-sstep-tag-line"></span>
