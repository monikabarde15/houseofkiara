...
import '../../../styles/howitworks/mobile/mobile-faq-section.css';
...
const MobileFAQSection = () => {
  ...
  return (
    <section id="section-faq" className="hok-hiw-mobile-faq">
      {/* Header */}
      <div className="hok-hiw-mobile-faq-header">
        <div className="hok-hiw-mobile-faq-eyebrow">
          <span className="hok-hiw-mobile-faq-line"></span>
          <span className="hok-hiw-mobile-faq-eyebrow-text">FAQ</span>
          <span className="hok-hiw-mobile-faq-line"></span>
        </div>
        
        <h2 className="hok-hiw-mobile-faq-title">
          Questions you <em>probably have.</em>
        </h2>
      </div>

      {/* FAQ Items */}
      <div className="hok-hiw-mobile-faq-items">
        {faqs.map((faq, index) => (
          <div 
            key={index} 
            className={`hok-hiw-mobile-faq-item ${index === 0 ? 'hok-hiw-mobile-faq-item-first' : ''} ${openIndex === index ? 'hok-hiw-mobile-open' : ''}`}
          >
            {/* Question */}
            <div 
              className="hok-hiw-mobile-faq-q" 
              onClick={() => toggleFAQ(index)}
            >
              <span className="hok-hiw-mobile-faq-txt">{faq.question}</span>
              <span className={`hok-hiw-mobile-faq-icon ${openIndex === index ? 'hok-hiw-mobile-open' : ''}`}>
            ...
            {/* Answer */}
            <div className="hok-hiw-mobile-faq-answer">
              <div className="hok-hiw-mobile-faq-answer-inner">
                {faq.answer}
              </div>
            </div>
          </div>
