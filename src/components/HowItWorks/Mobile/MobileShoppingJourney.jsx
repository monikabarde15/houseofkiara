...
const MobileShoppingJourney = () => {
  ...
  return (
    <section id="section-shop" className="hok-hiw-mobile-shop-section">
      {/* Section Header */}
          ...
          >
            ...
            <div className="hok-hiw-mobile-jstep-details">
              {step.details.map((detail, idx) => (
                <div key={idx} className="hok-hiw-mobile-jspd">
                  <span className="hok-hiw-mobile-jspd-dot"></span>
                  <span className="hok-hiw-mobile-jspd-text">{detail}</span>
                </div>
              ))}
            </div>
          </div>
      ...
      {/* Progress Dots */}
      <div className="hok-hiw-mobile-jdots" id="jdots-mob">
...
export default MobileShoppingJourney;